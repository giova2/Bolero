...
var app1 = new Vue({
    ...
    data: {
        ...
        isBusy: false,
        acciones: {
            strike: 'strike', spare: 'spare', espera: 'espera', tiro: 'tiro', bolaFuera: 'fuera', finalizado: 0
        },
        gifs: {
            strike: {
        ...
        ganador: '',
        values: {
                'open' : null, 'players' : 0, 'jugadorlanza' : '', 'accion': '',
                'jugador1nombre': '', 'jugador1puntostiro': '', 'jugador1puntostotales': '',
                'jugador2nombre': '', 'jugador2puntostiro': '', 'jugador2puntostotales': '',
                'jugador3nombre': '', 'jugador3puntostiro': '', 'jugador3puntostotales': '',
                'jugador4nombre': '', 'jugador4puntostiro': '', 'jugador4puntostotales': '',
                'jugador5nombre': '', 'jugador5puntostiro': '', 'jugador5puntostotales': '',
                'jugador6nombre': '', 'jugador6puntostiro': '', 'jugador6puntostotales': ''
        },
        ...
        fields: [
            { key:'player', label:'Player', tdClass:['jugador', 'text-center'], thClass:['d-none']},
            { key:'primero', /* label:'1',*/  tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'segundo', /* label:'2',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']}, 
            { key:'tercero', /* label:'3',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'cuarto', /* label:'4',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'quinto', /* label:'5',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'sexto', /* label:'6',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'septimo', /* label:'7',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'octavo', /* label:'8',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'noveno', /* label:'9',*/ tdClass:['puntaje','parcial', 'text-center'], thClass:['d-none']},
            { key:'decimo', /*label:'10',*/tdClass:['puntaje','parcial', 'ultimo', 'text-center'], thClass:['d-none']},
            { key:'final', label:'final',tdClass:['puntaje','final', 'text-center'], thClass:['d-none']},
    ...
    methods: {
        ...
        animacionStrike(){
            ...
            gsap.to($divStrikeGif, {duration:1, scale: 105, ease:"elastic",//scaleX:101, scaleY:101, ease:"elastic", 
                onComplete: () => {
                    // acá esperamos la reproducción del video y o bien seguimos con más animaciones, o bien ocultamos el div nuevamente
                }
            });
            setTimeout(() => {
                gsap.fromTo($divStrikeWordBg, 
                /* from */
                { 
                    scale:0.01
                },
                /* To */
                {
                    duration:0.5, scale: 2, ease:"expo",
                    onStart: () => {
                        $divStrikeWordBg.classList.remove('hide');
                    }
                });
                gsap.fromTo($divStrikeWordH1, 
                {   
                    scale:6
                },
                {
                    duration:1, delay: 0.1, scale:1.8,
                    ease: "bounce",
                    onStart: () => {
        ...
        animacionBolaFuera(){
            ...
            setTimeout(()=>{
                gsap.fromTo($divBolaFueraWordH1,
                    { scale:0.1 },
        ...
        animacionEspera(){
            ...
            gsap.fromTo($divEsperaGif,
                { scaleX:1, scaleY:1 },
                { duration:2, scaleX:101, scaleY:120, ease:"elastic" }
            );    
            setTimeout(()=>{
                gsap.fromTo($divEsperaWordH1, 
                    { scale: 0.1 },
        ...
        animacionTiro(){
            ...
            let $divTiroGif        = document.querySelector('#tirar div')
            // acá obtenemos todos los elementos que harán la animación de la explosión y la palabra
            ...
            gsap.fromTo($divTiroGif,
                { scaleX:1, scaleY:1 },
                {duration:2, scaleX:101, scaleY:150, translateY:"200px", ease:"elastic", 
                    onComplete: () => {
                        // acá esperamos la reproducción del video y o bien seguimos con más animaciones, o bien ocultamos el div nuevamente
                        setTimeout(()=>{
        ...
        filterValues: function(json){
            ...
            let claveAccion = vueApp.accionClave(json.topic);
            console.log('claveAccion', claveAccion)
            vueApp.values[claveAccion] = json.payload
            let palabraClaveOpen    = 'open'
            let palabraClavePlayers = 'players'
            let palabraClaveLanza   = 'jugadorlanza'
            let palabraClaveNombre  = 'nombre'
            let palabraClaveJugador = 'jugador'
            let palabraClavePuntos  = 'puntos'
            let palabraClaveAccion  = 'accion'
            let tiros = ['primero', 'segundo', 'tercero', 'cuarto', 'quinto', 'sexto', 'septimo', 'octavo', 'noveno', 'decimo']
            ...
            if(claveAccion.indexOf(palabraClaveNombre) != -1){
                ...
                vueApp.items[indexJugador].player = vueApp.values['jugador'+(nroJugador)+'nombre']
                
                console.log('nombre jugador:-> ', vueApp.values['jugador'+(nroJugador)+'nombre'])
            }
            ...
            if(claveAccion.indexOf(palabraClavePuntos) != -1){
                ...
                console.log('vueApp.items['+indexJugador+']['+nroTiro+'].first');
                ...
                if(vueApp.items[indexJugador][nroTiro].first == 0){
                    ...
                    vueApp.items[indexJugador][nroTiro].score = vueApp.values[ keyPuntosTotales ]
                ...
                } else if(vueApp.items[indexJugador][nroTiro].hasOwnProperty('third') && vueApp.items[indexJugador][nroTiro].third == 0){ //si es el decimo tiro y el turno 3 entonces tengo que completar este valor
